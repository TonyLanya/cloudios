        ...
        request
            ...
            .then(res => {
                ...
                if (platform.os.family == 'iOS') {
                    var templink = "itms-services://?action=download-manifest&url=http://47.100.36.49:4000/" + this.props.match.params.applink + "/" + this.props.match.params.applink + "_" + res.body.data.appversionname + ".plist";
